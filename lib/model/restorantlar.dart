...
class Restorantlar {
  ...
  factory Restorantlar.fromJson(Map<String, dynamic> json) {
    return Restorantlar(
      json['restoran_id'] as int? ?? 0, // 'restoran_id' varsa int olarak al, yoksa 0 döndür
      json['restoran_ad'] as String? ?? 'No Name', // 'restoran_ad' varsa String olarak al, yoksa 'No Name' döndür
      json['restoran_resim'] as String? ?? '', // 'restoran_resim' varsa String olarak al, yoksa boş string döndür
      json['restoran_puan'] as String? ?? 'No Rating', // 'restoran_puan' varsa String olarak al, yoksa 'No Rating' döndür
      json['restoran_aciklama'] as String? ?? 'No description', // 'restoran_aciklama' varsa String olarak al, yoksa 'No description' döndür

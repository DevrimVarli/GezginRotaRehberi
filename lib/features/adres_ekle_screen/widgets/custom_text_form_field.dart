...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12), // Padding ile alanın etrafında boşluk bırakılır
      child: TextFormField(
        ...
        controller: controller, // Formun verisini almak için controller kullanılır
        style: textTheme.titleMedium, // Text stilini tema ile uyumlu yapıyoruz
        decoration: InputDecoration(
          labelText: label, // Form alanının etiketi
          labelStyle: textTheme.titleMedium?.copyWith(
            color: colorScheme.onSurface.withValues(alpha: 0.6), // Etiket rengi tema ile uyumlu olur
          ),
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: const BorderRadius.all(Radius.circular(8)), // Kenar yuvarlama
            borderSide: BorderSide(
              color: colorScheme.onSurface.withValues(alpha: 0.6), // Normal durumdaki kenar rengi

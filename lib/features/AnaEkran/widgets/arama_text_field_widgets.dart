...
class AramaTextFieldWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: SizedBox(
        height:
            e * 0.06, // TextField'ın yüksekliğini ekranın %6'sı kadar yapıyoruz
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            labelStyle: TextStyle(
              ...
              color:
                  colorScheme.primary, // Etiket rengi tema ana rengiyle uyumlu
            ...
            hintStyle: GoogleFonts.roboto(
              ...
              color:
                  colorScheme
                      .outlineVariant, // İpucu yazı rengi tema ile uyumlu
              fontWeight: FontWeight.w500, // İpucu yazı kalınlığı
            ),
            filled: true, // Arka plan rengini dolu yapıyoruz
            fillColor: Colors.transparent.withValues(
              alpha: 0.02,
            ), // Zemin rengini şeffaf yapıyoruz

...
class CustomForm extends ConsumerStatefulWidget {
  ...
  formKey; // Formun global key'i, form durumunu kontrol etmek için kullanılır
      ...
      child: Column(
        children: <Widget>[
          ...
          CustomTextFormField(
            ...
            hintText: 'email'.tr(), // Giriş alanı için hint (yer tutucu) metni
          ...
          const SizedBox(
            height: 20,
          ), // E-posta ve şifre arasına boşluk ekliyoruz
          ...
          CustomTextFormField(
            ...
            hintText:
                'password'.tr(), // Giriş alanı için hint (yer tutucu) metni

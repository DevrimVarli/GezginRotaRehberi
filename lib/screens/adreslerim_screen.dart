...
const AdresScreen({super.key});
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    final konumlar=box.values.toList();
    ColorScheme colorScheme = Theme.of(context).colorScheme;
    TextTheme textTheme = Theme.of(context).textTheme;
    //List<KullaniciKonumFreezed> konumlar=ref.watch(kullaniciKonumlarProvider);
    return Scaffold(
      //backgroundColor: colorScheme.onSurface.withValues(alpha:14),
      appBar: AppBar(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Row(children: <Widget>[
                                    ...
                                    TextButton(
                                        onPressed: (){
                                          Navigator.pushReplacement(context, MaterialPageRoute<Widget>(builder: (context)=>AdresScreenDetay(kullaniciKonum: konum,)));
